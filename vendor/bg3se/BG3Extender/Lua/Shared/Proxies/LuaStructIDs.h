...
#define DECLARE_CLS(id, ...) template <> inline constexpr StructTypeId StructID<__VA_ARGS__> = StructTypeId(id);
#define DECLARE_CLS_FWD(id, cls) template <> inline constexpr StructTypeId StructID<cls> = StructTypeId(id);
#define DECLARE_CLS_NS_FWD(id, ns, cls) template <> inline constexpr StructTypeId StructID<ns::cls> = StructTypeId(id);
#define DECLARE_CLS_BARE_NS_FWD(id, ns, cls) template <> inline constexpr StructTypeId StructID<ns::cls> = StructTypeId(id);
#define DECLARE_STRUCT_BARE_NS_FWD(id, ns, cls) template <> inline constexpr StructTypeId StructID<ns::cls> = StructTypeId(id);
#include <GameDefinitions/Generated/PropertyMapNames.inl>
#undef DECLARE_CLS
#undef DECLARE_CLS_FWD
#undef DECLARE_CLS_NS_FWD
